  ...
  return (
    ...
    >
      ...
      {/* ════════════════════════════════════════════════════════
          ...
          ════════════════════════════════════════════════════════ */}
      <div className="relative w-full flex flex-col lg:flex-row items-center gap-8 lg:gap-4 mt-4">
        ...
        {/* ─── CENTER/RIGHT: Sphere + right-side card column ─── */}
        <div className="relative hidden lg:flex flex-col items-end justify-center gap-3 flex-shrink-0 w-auto">

          {/* Right-side cards column */}
          <div className="flex flex-col gap-3 items-end z-20">

            {/* Card 1 — Live Stream */}
            <div className="animate-float-slow pointer-events-auto">
              <div className="flex items-center gap-3 p-3 sm:p-3.5 rounded-[16px] bg-[rgba(15,8,30,0.82)] border border-[rgba(160,100,255,0.28)] backdrop-blur-[20px] shadow-[0_16px_40px_rgba(0,0,0,0.55),0_0_20px_rgba(34,211,238,0.12)] w-[210px]">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-[#777083] mt-0.5 truncate">48kHz 24-bit PCM</p>
                  <div className="flex items-end gap-[3px] h-2.5 mt-1.5">
                    {[30, 80, 50, 100, 65, 90, 40, 75, 55, 85].map((h, i) => (
                      <span
                        ...
                        style={{ height: `${h}%`, animationDelay: `${i * 90}ms`, animationDuration: "1.1s" }}
                      />
                    ))}
                  </div>
                </div>
            ...
            {/* Card 2 — Neural Latency */}
            <div className="animate-float-delayed pointer-events-auto" style={{ animationDelay: "0.4s" }}>
              <div className="flex items-center gap-2.5 px-4 py-3 rounded-[14px] bg-[rgba(15,8,30,0.82)] border border-[#22D3EE]/25 backdrop-blur-[20px] shadow-[0_16px_40px_rgba(0,0,0,0.55),0_0_16px_rgba(34,211,238,0.10)] w-[210px]">
                <div className="w-7 h-7 rounded-lg bg-[#22D3EE]/10 border border-[#22D3EE]/22 flex items-center justify-center flex-shrink-0">
                  <Zap className="w-3.5 h-3.5 text-[#22D3EE]" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="text-[9px] font-mono font-bold text-[#777083] uppercase tracking-wider">Neural Latency</div>
                  <div className="text-base font-black text-[#22D3EE] tracking-tight">&lt;15ms</div>
                </div>
                <div className="text-[8px] font-mono text-[#22D3EE]/70 bg-[#22D3EE]/8 border border-[#22D3EE]/15 px-1.5 py-0.5 rounded">REAL-TIME</div>
              </div>
            </div>

            {/* Card 3 — AI Detection */}
            <div className="animate-float-slow pointer-events-auto" style={{ animationDelay: "0.8s" }}>
              <div className="flex items-center gap-3 p-3 sm:p-3.5 rounded-[16px] bg-[rgba(15,8,30,0.82)] border border-[rgba(160,100,255,0.28)] backdrop-blur-[20px] shadow-[0_16px_40px_rgba(0,0,0,0.55),0_0_20px_rgba(139,92,255,0.15)] w-[210px]">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-[9px] font-mono font-bold text-[#777083] tracking-wider uppercase">AI DETECTION</div>
                  <div className="text-xl font-black text-[#F8F7FF] tracking-tight">{confidenceScore}%</div>
            ...
            {/* Card 4 — Risk Score */}
            <div className="animate-float-delayed pointer-events-auto" style={{ animationDelay: "1.2s" }}>
              <div className="flex items-center gap-2.5 p-3 sm:p-3.5 rounded-[16px] bg-[rgba(15,8,30,0.82)] border border-emerald-500/25 backdrop-blur-[20px] shadow-[0_16px_40px_rgba(0,0,0,0.55),0_0_16px_rgba(52,211,153,0.10)] w-[210px]">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <span className="text-[9px] font-mono font-bold text-[#777083] uppercase">RISK SCORE</span>
                    <span className="text-[8px] font-mono font-bold text-emerald-400 bg-emerald-500/10 px-1 py-0.5 rounded">LOW</span>
                  </div>
        ...
        {/* 3D Sphere — absolutely centered behind everything on desktop */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none -z-10">
          <div className="w-[260px] h-[260px] sm:w-[300px] sm:h-[300px] lg:w-[320px] lg:h-[320px] xl:w-[360px] xl:h-[360px] pointer-events-none flex items-center justify-center">
            <DhwaniSphere className="w-full h-full" />
          </div>
        </div>

        {/* ── Mobile: stacked cards below text (shown only < lg) */}
        <div className="flex lg:hidden flex-wrap gap-2.5 justify-center mt-6 w-full z-20">
          <div className="flex items-center gap-2 px-3 py-2 rounded-full bg-[rgba(15,8,30,0.82)] border border-[#22D3EE]/22 backdrop-blur-[16px] text-[10px] font-mono text-[#F8F7FF] shadow-lg">
            ...
            <span className="font-bold text-[#22D3EE]">LIVE</span>
            <span className="text-[#777083]">48kHz PCM</span>
          </div>
          <div className="flex items-center gap-2 px-3 py-2 rounded-full bg-[rgba(15,8,30,0.82)] border border-[#22D3EE]/22 backdrop-blur-[16px] text-[10px] font-mono text-[#F8F7FF] shadow-lg">
            <Zap className="w-3 h-3 text-[#22D3EE]" />
            <span className="font-bold text-[#22D3EE]">&lt;15ms</span>
            <span className="text-[#777083]">Latency</span>
          </div>
          <div className="flex items-center gap-2 px-3 py-2 rounded-full bg-[rgba(15,8,30,0.82)] border border-[rgba(160,100,255,0.25)] backdrop-blur-[16px] text-[10px] font-mono text-[#F8F7FF] shadow-lg">
            <Cpu className="w-3 h-3 text-[#C084FC]" />
            <span className="font-bold text-[#C084FC]">{confidenceScore}%</span>
            <span className="text-[#777083]">AI Detection</span>
          </div>
          <div className="flex items-center gap-2 px-3 py-2 rounded-full bg-[rgba(15,8,30,0.82)] border border-emerald-500/22 backdrop-blur-[16px] text-[10px] font-mono text-[#F8F7FF] shadow-lg">
            <ShieldCheck className="w-3 h-3 text-emerald-400" />
            <span className="font-bold text-emerald-400">18/100</span>
            <span className="text-[#777083]">Risk</span>
          </div>
        </div>
